...
Alternatively, you can install the binary from the source [here](https://github.com/warrensbox/gitapp-installer/releases) 
...
Please open  *issues* here: [New Issue](https://github.com/warrensbox/gitapp-installer/issues){:target="_blank"}
